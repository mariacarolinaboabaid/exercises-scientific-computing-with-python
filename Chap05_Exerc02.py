#THIS PROGRAM WILL SHOW THE SUM, TOTAL, MAXIMUM AND MINIMUM OF THE NUMBERS THAT THE USER PROVIDES UNTIL HE ENTERS "DONE!"
...
#IF THE USER DOES NOT ENTER NUMBER:
             ...
             print("Bad data!")
#PRITING THE RESULT:
print(sum(user_number_list), len(user_number_list), max(user_number_list), min(user_number_list))